...
public class Order {
	...
	public Order(String order_Num, String order_User_ID, String order_ProductNum, String order_PhoneNumber,
			...
			String shipping_Memo, String recipient, String order_thumbnail) {
		super();
		Order_Num = order_Num;
	...
	public String getOrder_thumbnail() {
		return Order_thumbnail;
	}

	public void setOrder_thumbnail(String order_thumbnail) {
		Order_thumbnail = order_thumbnail;
	}
