...
<body>
	...
	<ul class="menu__tabs">
		...
		<div class="login_txt">
			...
			<p class="forgot-pass"  style="font-size: 12px;" onclick="location.href='t2FindID.go?member=1'">아이디를 잊으셨나요?</p>
			<p class="forgot-pass"  style="font-size: 12px;" onclick="location.href='#'">비밀번호를 잊으셨나요?</p>
			<div class="box bg-1">
