	...
	<table border="1" class="tb">
	  <c:forEach var="p" items="${products}">
	    ...
	    <tr>
	       ...
	       <td><a href="get.aProductTeam1?product_num=${p.product_num}">
                <img src="resources/reviewFile/${p.product_thumnail }"></a>
                <div class="caption">  
                  <h2> ${fn:length(p.product_title)>20?fn:substring(p.product_title,0,20)+="...":p.product_title }</h2>
                  <p><fmt:formatNumber value="${p.product_price }" pattern="#,###" />원</p></td>
	    <c:if test="${i%j == j-1 }">
	    </tr>
	    </c:if>
